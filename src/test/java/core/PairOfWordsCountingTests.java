...
public class PairOfWordsCountingTests {
    ...
    public void emptyString_ShouldReturnEmptyMap() {
        ...
        assertEquals(expected, wordCounter.countPairOfWords(""));
    }

    @Test
    public void wordAlone_ShouldReturnEmptyMap() {
        Map<String, Integer> expected = new HashMap<>();
        assertEquals(expected, wordCounter.countPairOfWords("one"));
    }
    ...
    public void pairOfWords_ShouldReturnThemOnce() {
        ...
        assertEquals(expected, wordCounter.countPairOfWords("one two"));
    }
    ...
    public void threeWords_ShouldReturnPairsOfNeighboursOnce() {
        ...
        assertEquals(expected, wordCounter.countPairOfWords("you are beautiful"));
    }
    ...
    public void fourWords_ShouldReturnPairsOfNeighboursOnce() {
        ...
        assertEquals(expected, wordCounter.countPairOfWords("you are beautiful are"));
    }
    ...
    public void complexText_ShouldCountCorrectly() {
        ...
        assertEquals(expected, wordCounter.countPairOfWords(text));
    }
}
